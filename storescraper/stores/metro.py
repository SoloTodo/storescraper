...
from storescraper.utils import vtex_preflight, session_with_proxy, check_ean13, \
    html_to_markdown
...
class Metro(Store):
    ...
    def discover_urls_for_category(cls, category, extra_args=None):
        ...
        while True:
            ...
            endpoint = 'https://www.metro.pe/_v/segment/graphql/v1' \
    ...
    def preflight(cls, extra_args=None):
        return vtex_preflight(
            extra_args, 'https://www.metro.pe/tecnologia/televisores')
