...
class OutletMedina(Store):
    ...
    def discover_urls_for_category(cls, category, extra_args=None):
        ...
        for url_extension, local_category in url_extensions:
            ...
            while True:
                ...
                url_webpage = "https://outletmedina.cl/{}" "?page={}".format(
                    url_extension, page
                )
                data_json = json.loads(session.get(url_webpage).text)
                soup = BeautifulSoup(data_json["rendered_products"], "lxml")
    ...
    def products_for_url(cls, url, category=None, extra_args=None):
        ...
        image_list = soup.find("div", {"id": "product-images-large"}).findAll("img")
        image_urls = []
