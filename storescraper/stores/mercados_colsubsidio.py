...
class MercadosColsubsidio(Store):
    @classmethod
    def categories(cls):
        return [TELEVISION]
    ...
    def discover_urls_for_category(cls, category, extra_args=None):
        ...
        while True:
            ...
            endpoint = (
                "https://www.mercadocolsubsidio.com/_v/segment/graphql/v1"
            ...
            for product_entry in product_entries:
                product_url = "https://www.mercadocolsubsidio.com/{}/p".format(
    ...
    def products_for_url(cls, url, category=None, extra_args=None):
        ...
        for picture_id in picture_ids:
            ...
            if not validators.url(picture_node["imageUrl"]):
                continue
    ...
    def preflight(cls, extra_args=None):
        return vtex_preflight(
            extra_args,
            "https://www.mercadocolsubsidio.com/tecnologia/televisores",
        )
