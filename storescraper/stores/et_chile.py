...
class ETChile(Store):
    ...
    def discover_urls_for_category(cls, category, extra_args=None):
        url_extensions = [
            ...
            ['productos/partes-y-piezas/almacenamiento/discos-duros', STORAGE_DRIVE],
            ['productos/almacenamiento-y-drives/hdd-interno', STORAGE_DRIVE],
            ['productos/partes-y-piezas/almacenamiento/ssd', SOLID_STATE_DRIVE],
            ['productos/almacenamiento-y-drives/discos-externos',
             EXTERNAL_STORAGE_DRIVE],
            ['productos/almacenamiento-y-drives/ssd-externo',
             EXTERNAL_STORAGE_DRIVE],
            ['productos/almacenamiento-y-drives/ssd-interno-almacenamiento-y-drives',
             SOLID_STATE_DRIVE],
            ...
            ['productos/partes-y-piezas/refrigeracion/ventiladores', CPU_COOLER],
            ['productos/partes-y-piezas/refrigeracion/water-cooling', CPU_COOLER],
