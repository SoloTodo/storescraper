...
from storescraper.categories import (MOTHERBOARD, RAM, STORAGE_DRIVE,
                                     SOLID_STATE_DRIVE, VIDEO_CARD,
                                     COMPUTER_CASE, POWER_SUPPLY, MONITOR,
                                     HEADPHONES, KEYBOARD, ALL_IN_ONE,
                                     NOTEBOOK, UPS)
...
class Interstock(StoreWithUrlExtensions):
    ...
    def discover_urls_for_url_extension(cls, url_extension, extra_args):
        ...
        while True:
            ...
            url_webpage = ('https://interstock.cl/categoria-producto/{}/'
