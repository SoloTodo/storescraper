    ...
    def discover_urls_for_category(cls, category, extra_args=None):
        ...
        category_urls = [
            ...
            ['electrohogar/electrodomesticos/aspiradoras-y-enceradoras',
             'VacuumCleaner'],
            ['electrohogar/lavanderia/lavadoras', 'WashingMachine'],
            ['electrohogar/lavanderia/secadoras', 'WashingMachine'],
            ['electrohogar/lavanderia/lavadoras-secadoras', 'WashingMachine'],
            ['electrohogar/lavanderia/doble-carga', 'WashingMachine'],
