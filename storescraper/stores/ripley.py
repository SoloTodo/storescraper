...
class Ripley(Store):
    ...
    def discover_urls_for_category(cls, category, extra_args=None):
        ...
        category_urls = [
            ...
            ['electro/cocina/hornos-electricos', 'Oven'],
            ['electro/electrodomesticos/aspiradoras-y-enceradoras',
             'VacuumCleaner'],
            ['electro/lavanderia/lavadoras', 'WashingMachine'],
            ['electro/lavanderia/secadoras', 'WashingMachine'],
            ['electro/lavanderia/lavadoras-secadoras', 'WashingMachine'],
            ...
            ['electro/climatizacion/ventilacion-y-aire-acondicionado',
             'AirConditioner'],
            ['electro/bano/calefont-y-termos', 'WaterHeater'],
            ['electro/climatizacion/estufas', 'SpaceHeater'],
