...
from storescraper.categories import CASE_FAN, COMPUTER_CASE, HEADPHONES, KEYBOARD, MONITOR, MOTHERBOARD, MOUSE, POWER_SUPPLY, PROCESSOR, RAM, STORAGE_DRIVE, VIDEO_CARD
    ...
    def discover_urls_for_category(cls, category, extra_args=None):
        ...
        for url_extension, local_category in url_extensions:
            ...
            while True:
                ...
                url_webpage = 'https://www.akbytecomputacion.cl/categoria-producto/{}/' \
