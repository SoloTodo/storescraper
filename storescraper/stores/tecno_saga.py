...
class TecnoSaga(Store):
    ...
    def discover_urls_for_category(cls, category, extra_args=None):
        ...
        for url_extension, local_category in url_extensions:
            ...
            while True:
                ...
                body = {
                    "mostrar": 16,
                    "id_categoria": categories[-1],
                    "id_subcategoria": categories[-2],
                    "pagina": page,
                }
                ...
                for container in product_containers:
                    product_url = (
                        "https://tecnosaga.cl/productos/detalle/" + container["url"]
                    )
    ...
    def products_for_url(cls, url, category=None, extra_args=None):
        ...
        normal_price = Decimal(
            soup.find("ul", "product-meta producto-tarjeta")
            .text.strip()
            .split()[1]
            .replace(".", "")
        )
        offer_price = Decimal(
            soup.find("ul", "product-meta producto-normal")
            .text.strip()
            .split()[1]
            .replace(".", "")
        )
