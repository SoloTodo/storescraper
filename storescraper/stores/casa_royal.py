...
from storescraper.utils import html_to_markdown, session_with_proxy, vtex_preflight
...
class CasaRoyal(StoreWithUrlExtensions):
    url_extensions = [
        ...
        ["computacion/accesorios-computacion/teclados-de-computacion", KEYBOARD],
        ["computacion/accesorios-computacion/mouse", MOUSE],
        ["computacion/accesorios-computacion/parlantes-de-computacion", STEREO_SYSTEM],
        ["computacion/accesorios-computacion/teclados", KEYBOARD],
        ["computacion/accesorios-computacion/parlantes-computacion", STEREO_SYSTEM],
        ...
        [
            "electronica-y-electricidad/computacion/teclados-de-" "computacion.html",
            KEYBOARD,
        ],
    ...
    def discover_urls_for_url_extension(cls, url_extension, extra_args):
        ...
        while not done:
            ...
            facets = [{"key": "c", "value": x} for x in url_extension.split("/")]
            ...
            endpoint = (
                "https://www.casaroyal.cl/_v/segment/graphql/v1?"
    ...
    def preflight(cls, extra_args=None):
        return vtex_preflight(extra_args, "https://www.casaroyal.cl/audio/audifonos")
