                ...
                if "fullPrice" in product_entry:
                    price = Decimal(
                        product_data["displayValues"]["prices"][
                            product_entry["fullPrice"]
                        ]["amountBeforeTradeIn"]
                    )
                elif "price" in product_entry:
                    price = Decimal(
                        product_data["displayValues"]["prices"][product_entry["price"]][
                            "currentPrice"
                        ]["raw_amount"]
                    ).quantize(0)
                else:
