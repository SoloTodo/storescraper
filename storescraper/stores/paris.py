...
class Paris(Store):
    category_paths = [
        ...
        ['electro/audio-1', ['StereoSystem', 'Headphones'],
         'Electro > Audio', 0],
        ['electro/audio/parlantes-bluetooth-portables-1', ['StereoSystem'],
         'Electro > Audio > Parlantes Bluetooth y Portables', 1],
        ['electro/audio/micro-minicomponentes-1', ['StereoSystem'],
         'Electro > Audio > Micro y Minicomponentes', 1],
        ['electro/audio/audifonos-1', ['Headphones'],
         'Electro > Audio > Audífonos', 1],
        ['electro/audio/audifonos-inalambricos-1', ['Headphones'],
    ...
    def banners(cls, extra_args=None):
        ...
        sections_data = [
            ...
            [bs.AUDIO, 'Audio', bs.SUBSECTION_TYPE_MOSAIC, 'electro/audio-1/'],
            [bs.AUDIO, 'Parlantes Bluetooth y Portables',
             bs.SUBSECTION_TYPE_MOSAIC,
             'electro/audio/parlantes-bluetooth-portables-1/'],
            [bs.AUDIO, ' Micro y Minicomponentes',
             bs.SUBSECTION_TYPE_MOSAIC,
             'electro/audio/micro-minicomponentes-1/'],
