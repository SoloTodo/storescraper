...
class MercadoLibreChile(Store):
    categories_code = [('MLC1051', 'Celulares y Telefonía', None),
                       ...
                       ('MLC1010', 'Audio', None), ('MLC5054', 'Cables', None),
                       ...
                       'StereoSystem'), ('MLC3697', 'Audífonos', 'Headphones'),
                       ...
                       ('MLC455245', 'Xbox Series X/S', 'VideoGameConsole'),
                       ...
                       'MemoryCard'), ('MLC439596', 'Audífonos', 'Headphones'),
                       ('MLC448169', 'Controles para Gamers', None),
                       ('MLC187264', 'Sillas Gamer', 'GamingChair'),
                       ('MLC439597', 'Otros', None),
                       ('MLC159228', 'Para PlayStation', None),
                       ('MLC159227', 'Para Xbox', None), (
                       'MLC116370', 'PS4 - PlayStation 4', 'VideoGameConsole'),
                       (
                       'MLC455263', 'PS5 - PlayStation 5', 'VideoGameConsole'),
                       ('MLC440985', 'Cables y Adaptadores', None),
                       ('MLC116375', 'Otros', None),
                       ('MLC430598', 'Almacenamiento', 'StorageDrive'),
                       ...
                       ('MLC3378', 'Parlantes para PC', 'StereoSystem'),
                       ...
                       ('MLC10177', 'Home Theater', 'StereoSystem'),
                       ('MLC1022', 'Parlantes y Subwoofers', 'StereoSystem'),
                       ('MLC2531', 'Climatización', 'AirConditioner'),
                       ('MLC1580', 'Hornos y Cocinas', 'Oven'),
                       ('MLC1578', 'Lavado', 'WashingMachine'),
                       ('MLC1576', 'Refrigeración', 'Refrigerator'),
                       ('MLC9456', 'Refrigeradores', 'Refrigerator'),
                       ('MLC179816', 'Repuestos y Accesorios', None),
                       ('MLC4337', 'Aspiradoras', 'VacuumCleaner'),
                       ('MLC180993', 'Aspiradoras Robot', 'VacuumCleaner'),
                       ('MLC455108', 'Repuestos y Accesorios', None),
                       ('MLC178593', 'Lavadora-Secadoras', 'WashingMachine'),
                       ('MLC174300', 'Lavavajillas', None),
                       ('MLC27590', 'Secadoras', 'WashingMachine'),
                       ('MLC29800', 'Aires Acondicionados', 'AirConditioner'),
                       ...
                       ('MLC11860', 'Parlantes', 'StereoSystem'),
                       ...
                       ('MLC1720', 'UPS', 'Ups'), ('MLC1722', 'Otros', None),
                       ...
                       ('MLC180910', 'Fuentes de Alimentación', 'PowerSupply'),
                       ...
                       ('MLC1672', 'Discos Duros y SSDs', 'StorageDrive'),
                       ...
                       ('MLC2930', 'PS2 - PlayStation 2', 'VideoGameConsole'),
                       ('MLC11623', 'PS3 - PlayStation 3', 'VideoGameConsole'),
                       ...
                       ('MLC420068', 'Fuentes de Alimentación', 'PowerSupply'),
                       ('MLC180986', 'Skins', None),
                       ('MLC439615', 'Controles y Joysticks', None),
                       ('MLC11625', 'Otros', None), (
                       'MLC4396', 'Game Boy Advance - GBA',
                       'VideoGameConsole'),
                       ('MLC2921', 'Game Cube', 'VideoGameConsole'),
                       ('MLC178658', 'Nintendo Switch', 'VideoGameConsole'),
                       ('MLC11223', 'Nintendo Wii', 'VideoGameConsole'),
                       ('MLC116432', 'Nintendo Wii U', 'VideoGameConsole'),
                       ('MLC161960', 'Otros Nintendos', None),
                       ('MLC190762', 'Fuentes de Alimentación', 'PowerSupply'),
                       ...
                       ('MLC30988', 'Otros', None), ('MLC1590', 'Otros', None),
                       ...
                       ('MLC1695', 'Fuentes de Poder', 'PowerSupply'),
                       ('MLC438144', 'A Combustión', None),
                       ('MLC440821', 'Gabinetes', 'ComputerCase'),
                       ...
                       ('MLC3707', 'Discos Duros y SSDs', 'StorageDrive'),
                       ...
                       ('MLC172568', 'Parlantes Portátiles', 'StereoSystem'),
                       ...
                       ('MLC455686', 'Torres de Sonido', 'StereoSystem'),
                       ...
                       ('MLC2675', 'Amplificadores', 'StereoSystem'),
                       ...
                       ('MLC455264', 'Fuentes de Alimentación', 'PowerSupply'),
        ...
        while True:
            ...
            for container in product_containers['results']:
                ...
                if not seller_id and not official_store_id:
                    for category_code, category_ml, real_category in cls.categories_code:
                        if category_code == container[
                            'category_id'] and real_category != category:
                            continue
    ...
    def discover_urls_for_category(cls, category, extra_args=None):
        ...
        product_urls = []
        query_categories_name = []
        query_categories_code = []
        for category_code, category_name, real_cateogry in cls.categories_code:
            if real_cateogry == category:
                product_urls.extend(
                    cls.get_products(session, category, category_code))

        # for category_name in cls.categories_name.items():
        #     if category_name[1] == category:
        #         query_categories_name.append(category_name[0])
        #
        # for category_code in cls.categories_code.items():
        #     if category_code[1] in query_categories_name:
