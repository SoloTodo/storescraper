...
class MercadoLibreChile(Store):
    ...
    categories_code = [
        ("MLC1051", "Celulares y Telefonía", None),
        ...
        ("MLC6263", "Kits de Mouse y Teclado", KEYBOARD_MOUSE_COMBO),
        ...
        ("MLC430367", "Tarjetas de Memoria y Lectores", MEMORY_CARD),
        ...
        ("MLC1696", "Gabinetes y Soportes de PC", COMPUTER_CASE),
        ("MLC1715", "Cables", None),
        ...
        ("MLC11625", "Otros", None),
        ("MLC4396", "Game Boy Advance - GBA", VIDEO_GAME_CONSOLE),
    ...
    def get_products(
        ...
        base_url = "https://api.mercadolibre.com/sites/MLC/search?" "limit=50"
            ...
            for container in product_containers["results"]:
                ...
                if not seller_id and not official_store_id:
                    for (
                        ...
                        category_ml,
                        real_category,
                    ) in cls.categories_code:
                        if (
                            category_code == container["category_id"]
                            and real_category != category
                        ):
    ...
    def discover_urls_for_category(cls, category, extra_args=None):
        ...
        for category_code, category_name, real_category in cls.categories_code:
            if real_category == category:
                product_urls.extend(cls.get_products(session, category, category_code))
        return product_urls
