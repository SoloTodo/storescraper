...
from storescraper.categories import ALL_IN_ONE, CASE_FAN, COMPUTER_CASE, \
    CPU_COOLER, EXTERNAL_STORAGE_DRIVE, GAMING_CHAIR, HEADPHONES, KEYBOARD, \
...
class CNava(Store):
    ...
    def discover_urls_for_category(cls, category, extra_args=None):
        ...
        for url_extension, local_category in url_extensions:
            ...
            while True:
                ...
                url_webpage = 'https://www.cnava.cl/product-category/{}/' \
    ...
    def products_for_url(cls, url, category=None, extra_args=None):
        ...
        p_price = soup.find(
            'div', 'product-info'
        ).findAll('div', 'price-wrapper')[1]
        normal_price = Decimal(remove_words(
            p_price.find('span', 'amount').text))
