...
from storescraper.categories import (
    KEYBOARD, NOTEBOOK, RAM, PROCESSOR, PRINTER,  MONITOR, MOTHERBOARD,
    HEADPHONES, VIDEO_CARD, SOLID_STATE_DRIVE, EXTERNAL_STORAGE_DRIVE, MOUSE)
...
class Eylstore(StoreWithUrlExtensions):
    ...
    url_extensions = [
        ...
        ['almacenamiento/disco-nvme', SOLID_STATE_DRIVE],
        ...
        ['gaming/tarjetas-de-video', VIDEO_CARD],
        ['gaming/audifonos-gaming', HEADPHONES],
        ['gaming/monitores-gaming', MONITOR],
        ['gaming/mouse-gaming', MOUSE],
        ['gaming/teclados-gaming', KEYBOARD],
        ['impresion/impresoras-laser', PRINTER],
        ['impresion/impresoras-tinta', PRINTER],
        ['monitores', MONITOR],
        ['notebooks/gaming-notebooks', NOTEBOOK],
        ['notebooks/oficina', NOTEBOOK],
        ['notebooks/ultra-livianos', NOTEBOOK],
        ['notebooks/workstation', NOTEBOOK],
    ...
    def discover_urls_for_url_extension(cls, url_extension, extra_args):
        ...
        if len(widget_tags) > 1:
            ...
            while True:
                ...
                soup = BeautifulSoup(
                    res.json()['data']['html'], 'html.parser')
