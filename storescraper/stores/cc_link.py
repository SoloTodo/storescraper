...
class CCLink(StoreWithUrlExtensions):
    url_extensions = [
        ...
        ["partes-y-piezas/almacenamiento/discos-opticos-internos", STORAGE_DRIVE],
        [
            "partes-y-piezas/almacenamiento/discos-duros-externos",
            EXTERNAL_STORAGE_DRIVE,
        ],
        ["partes-y-piezas/almacenamiento/discos-duros-internos", STORAGE_DRIVE],
    ...
    def discover_urls_for_url_extension(cls, url_extension, extra_args=None):
        ...
        while True:
            ...
            url_webpage = "https://www.cclink.cl/productos/{}/".format(url_extension)
            ...
            product_containers = soup.find("ul", {"data-bs-toggle": "shop-products"})
    ...
    def products_for_url(cls, url, category=None, extra_args=None):
        ...
        offer_price = Decimal(
            remove_words(
                soup.find("div", "product-actions-wrapper").findAll("bdi")[0].text
            )
        )
