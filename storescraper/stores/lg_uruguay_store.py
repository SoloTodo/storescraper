...
from storescraper.categories import TELEVISION, REFRIGERATOR, \
    WASHING_MACHINE, STEREO_SYSTEM
...
class LgUruguayStore(Store):
        ...
        for url_extension, local_category in url_extensions:
            ...
            while True:
                ...
                product_containers = soup.find('div', {
                    'id': 'catalogoProductos'}).findAll('div', 'it')
    ...
    def products_for_url(cls, url, category=None, extra_args=None):
        ...
        if soup.find('ul', 'lst lstThumbs'):
            ...
            picture_urls = ['https:' +
                            soup.find('div', {'id': 'fichaProducto'}).find(
                                'div', 'cnt').find('img')['src']]
        p = Product(
            name,
            cls.__name__,
            category,
