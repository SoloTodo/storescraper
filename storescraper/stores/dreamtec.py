...
from storescraper.categories import ALL_IN_ONE, GAMING_CHAIR, HEADPHONES, \
    MONITOR, NOTEBOOK, PRINTER, STEREO_SYSTEM, TABLET, TELEVISION, \
    VIDEO_GAME_CONSOLE, MOUSE
from storescraper.product import Product
from storescraper.store_with_url_extensions import StoreWithUrlExtensions
from storescraper.utils import session_with_proxy, \
    html_to_markdown, check_ean13
...
class Dreamtec(StoreWithUrlExtensions):
    ...
    def discover_urls_for_url_extension(cls, url_extension, extra_args):
        ...
        while True:
            ...
            url_webpage = 'https://dreamtec.cl:3000/categoria/{}?page={}'.format(url_extension, page)
            print(url_webpage)
    ...
    def products_for_url(cls, url, category=None, extra_args=None):
        ...
        picture_urls = ['https://dreamtec.cl/' + product_data[tag].replace(' ', '%20')
