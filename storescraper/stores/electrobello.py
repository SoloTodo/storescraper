...
class Electrobello(Store):
    ...
    def discover_urls_for_category(cls, category, extra_args=None):
        ...
        while True:
            ...
            endpoint = (
                "https://www.electrobello.com/_v/segment/graphql/v1"
            ...
            for product_entry in product_entries:
                product_url = "https://www.electrobello.com/{}/p".format(
    ...
    def preflight(cls, extra_args=None):
        return vtex_preflight(
            extra_args,
            "https://www.electrobello.com/tecnologia/audio",
        )
