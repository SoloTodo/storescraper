...
class PowerPlay(Store):
    ...
    def discover_urls_for_category(cls, category, extra_args=None):
        url_extensions = [
            ...
            ["componentes-partes-piezas/gabinetes-estandar-gamer", COMPUTER_CASE],
        ...
        for url_extension, local_category in url_extensions:
            ...
            while True:
                ...
                url_webpage = (
                    "https://power-play.cl/product-category/{}/"
                ...
                if "404!" in soup.text:
                    break
                product_containers = soup.find("div", {"id": "content"}).findAll(
                    "li", "product"
                )
