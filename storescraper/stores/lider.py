...
class Lider(Store):
    ...
    def discover_entries_for_category(cls, category, extra_args=None):
        category_paths = [
            ...
            ['Tecno/Tecnología_Portable/Consolas', ['VideoGameConsole'],
             'Tecno > Tecnología Portable > Consolas', 1],
            ['Telefonía/Celulares_y_Teléfonos/Smartphones', ['Cell'],
             'Telefonía > Celulares y Teléfonos > Smartphones', 1],
            ['Telefonía/Celulares_y_Teléfonos/Celulares_Básicos', ['Cell'],
             'Telefonía > Celulares y Teléfonos > Celulares_Básicos', 1],
            ['Telefonía/Wearables/Smartwatchs', ['Wearable'],
             'Telefonía > Wearables > Smartwatchs', 1],
            ['Telefonía/Wearables/Smartbands', ['Wearable'],
             'Telefonía > Wearables > Smartbands', 1],
            ['Telefonía/Accesorios_Telefonía/Audífonos', ['Headphones'],
             'Telefonía > Accesorios Telefonía > Audífonos', 1],
            ['Telefonía/Accesorios_Telefonía/Tarjetas_de_memoria',
             ['MemoryCard'],
             'Telefonía > Accesorios Telefonía > Tarjetas_de_memoria', 1],
            ...
            ['Electrohogar/Refrigeración/Refrigeradores_Side_By_Side',
             ['Refrigerator'],
             'Electrohogar > Refrigeración > Refrigeradores Side By Side', 1.0],
